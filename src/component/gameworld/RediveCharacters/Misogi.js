...
<img src={newLocal} alt="redive" className="character" />
            ...
            <h2>소개</h2>
                <p>
                    <strong>【물리】</strong>최전열에서 적의 물리 공격을 방해하는 개구쟁이 소녀.<br/>
                    눈앞의 적을 암흑 상태로 만들어 명중률을 큰 폭으로 낮추는 한 편<br/>
                    적 하나의 물리 공격력을 낮추는 스킬을 가지고 있다.
                </p>

            <h2>스킬</h2>
                <ul>
                    <li><strong>【UB】트릭 하트</strong><br/>
                        적 전체에게 물리 (중) 데미지, 적 전체의 물리 공격력 및 물리 크리티컬 (특대) 감소<br/>
                        물리 크리티컬 시 피해량 (중) 감소
                    </li>
                    <p/>
                    <li><strong>【skill 1】잉크 슈터 +</strong><br/>
                        자신으로부터 두 번째로 가까운 적 하나에게 물리 (중) 데미지<br/>
                        대상을 암흑 상태로 만듦, 범위 내 적 모두의 물리 공격력 (소) 감소
                    </li>
                    <p/>
                    <li><strong>【skill 2】워터 벌룬</strong><br/>
                        물리 공격력이 가장 높은 적 하나에게 물리 (소) 데미지, 대상의 물리 공격력 (소) 감소<br/>
                        자신의 물리 공격력 (소) 증가
                    </li>
                    <p/>
                    <li><strong>【EX】트랩 익스퍼트 +</strong><br/>
...
<img src={newLocal_1} alt="redive" className="character" />
            ...
            <h2>스킬</h2>
                <ul>
                    <li><strong>【UB】트릭 오어 트릭!</strong><br/>
                        【카운트다운】전방의 적 전체에게 폭탄을 설치하고 5카운트 후 폭발<br/>
                        폭탄은 각각 폭발 시 적 전체에게 물리 (중) 데미지
                    </li>
                    <p/>
                    <li><strong>【skill 1】페인팅 킥 +</strong><br/>
                        전방 범위 내 적 전체에게 물리 (중) 데미지, 해당 스킬로 피해를 받은 적의 물리 공격력 (중) 감소<br/>
                        이 스킬이 크리티컬 시 피해량이 2배가 아닌 3배가 된다
                    </li>
                    <p/>
                    <li><strong>【skill 2】깜짝 펌킨</strong><br/>
                        앞에서 세 번째 적을 중심으로 범위 내 적 전체에게 물리 (중) 데미지
                    </li>
                    <p/>
                    <li><strong>【EX】트릭 익스퍼트 +</strong><br/>
